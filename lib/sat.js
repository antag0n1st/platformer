...
(function (root, factory) {
  ...
  Pool.prototype.get = function(){
      if(this.index >= this.count){
          this.objects.push(new Vector(0,0)); 
          this.count++;
      }
  ...
  /**
   * @argument {number} length description
   * @return {number} The length of this vector.
   */
  Vector.prototype['setLength'] = Vector.prototype.setLength = function(length) {
  ...
  // Set X to this vector.
  /**
   * @param {number} x value
   * @return {Vector} this for chaning
   */
  Vector.prototype['setX'] = Vector.prototype.setX = function(x) {
    this.x = x;
    return this;
  };
  
  // Set Y to this vector.
  /**
   * @param {number} y value
   * @return {Vector} this for chaning
   */
  Vector.prototype['setY'] = Vector.prototype.setY = function(y) {
    this.y = y;
    return this;
  };
  
  // Set Angle to this vector.
  /**
   * @param {number} angle the angle
   * @return {Vector} this for chaning
   */
  Vector.prototype['setAngle'] = Vector.prototype.setAngle = function(angle) {
    var length = this.len();
    this.x = Math.cos(angle) * length;
    this.y = Math.sin(angle) * length;
    return this;
  ...
  // Get Angle to this vector.
  /**
   * @return {number} this for chaning
   */
  Vector.prototype['getAngle'] = Vector.prototype.getAngle = function() {
    return Math.atan2(this.y, this.x);
  };
  
  // Add two vectors
  /**
   * @param {Vector} v1 The other Vector.
   ...
   * @return {Vector} result vector.
   */
  Vector['substruction'] = function(v1,v2) {    
    return new Vector(v1.x-v2.x,v1.y-v2.y);
  };
  ...
  Polygon.prototype['recalc'] = Polygon.prototype.recalc = function() {
    ...
    if(calcPoints.length === 0){
        ...
        var len = points.length;
        for (i = 0; i < len; i++) {
          var calcPoint = new Vector().copy(points[i]);
